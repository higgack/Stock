...
| 수집 | yfinance `yf.download(chunk=120, period="3mo")` 벌크 · 첫 실행만 `"1y"` 백필 | 신고저 스캔 검증 패턴 · 3h 당 15요청 |
...
- 부하: 유니버스 ≈ 350+503+225×4 = 1,753 → 120 배치 15회 × 3mo / 3h. 신고저 :00 슬롯(9,358 × 1y)의 약 1/5. 첫 실행 백필(1y × 15) 1회. KR 마스터파일 HTTP 2건/7일.
