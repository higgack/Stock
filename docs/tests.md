...
**재현이 먼저**(§Pre-commit 9): 제품 생산부로 그 사유를 다시 만들자 541자였고
`machine_detail_at` 이 **478** 을 돌려줬다 — 잘린 것은 63자뿐이었다.
...
**결과**: 725자 → **175자**. 화면에 남는 것 = 무엇으로 대체했나 · 기준일 ·
...
**검증**: `TestVolumeBannerAudience20260921` 9건 + 기존
