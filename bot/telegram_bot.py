...
<b>【11. 대시보드】</b> 🦉 영구 보관
 ...
 • 상단 카드 4개: 📊 총 분석 / 💰 비용·도구 실패율 / ⏱ 평균 시간 / 🎯 정확도 (알파 기준 = raw 수익−섹터 ETF, Hold는 정확도 분모만 제외 평균엔 포함)
 • 본문: 날짜 아코디언 · 카드 + 상세 페이지 양쪽에 5/15/30 거래일 결과 누적 표시 (raw·알파·매수/매도 추천 맞음/틀림·섹터대비 high/low·구체 ETF) 윈도별 hit/miss 독립 색상 · 🗑️ 영구 삭제
