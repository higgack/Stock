...
<b>【9. 대시보드】</b> 3개 entry — 나머지(Screener·레딧·Daily Byte·📝블로그(글 요약+원문 아카이브)·부동산·청약·수출입)는 🌍Main nav, 워치·도메인목록은 Screener nav 에서
 🌍 <b>Main</b> — 글로벌스냅샷·Macro(금리·물가·환율·센티먼트) · 다가오는실적(한·미·일·대·중·홍 6시장 탭·미국 한글명·날짜 드롭다운 필터) · 리서치액션(30일치·한국 기업/산업/전략(네이버)+미국TP·미국 한글명·날짜 드롭다운 필터) · 관심종목(시총·PER(적자표시)·EPS FY라벨·등락·정렬/나라·실적일 필터/순서) · 📋DART공시(40+종 구조화 카드·🔥중요/⚠️미파싱/미파싱제외 색상+카테고리 동시필터·소송/리스크/조회공시/공정공시/자율공시 파싱·지분 노이즈컷·CSV) · 업종등락(한·미·일·대·중·홍 — 업종별시세·신고가신저가·급등급락·미국 장전/장후 · 비보통주(권리·유닛) 제외 · 장중 자동갱신: 신고저 1h·그 외 30s·탭 복귀 즉시·NXT 포함) · 종목검색(헤더→탭→차트 즉시) · 홈 복귀 시 마지막 스크롤 위치 복원
