"""Specialty & Generic Pharma — L4 under Pharmaceuticals & Biotechnology (제약 및 바이오테크).
...
THEME = {
    "domain": "Specialty & Generic Pharma (Pharmaceuticals & Biotechnology)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["generic_pharma", "generic"],
    "horizon": "9-24 months",
    "binding_layer_taxonomy": [
        "Specialty & Generic Pharma — 미국 (Teva TEVA · Viatris VTRS · Bausch BHC · Perrigo PRGO)",
        "Specialty & Generic Pharma — 비상장 (Endo 비상장 · Mallinckrodt 비상장)",
        "Specialty & Generic Pharma — 유럽 (Sandoz SDZ.SW)",
    ],
    "catalyst_types": [
