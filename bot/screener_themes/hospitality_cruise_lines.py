"""Cruise Lines — L4 under Hospitality & Leisure (호텔 및 레저).
...
THEME = {
    "domain": "Cruise Lines (Hospitality & Leisure)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["cruise_lines", "lines"],
    "horizon": "6-18 months",
    "binding_layer_taxonomy": [
        "Cruise Lines — 주요 (Carnival CCL · Royal Caribbean RCL)",
        "Cruise Lines — 기타·공급망 (Norwegian Cruise Line NCLH · Lindblad Expeditions LIND · OneSpaWorld OSW)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "Cruise Lines (주요)": "Carnival CCL · Royal Caribbean RCL",
        "Cruise Lines (확장)": "Norwegian Cruise Line NCLH · Lindblad Expeditions LIND · OneSpaWorld OSW",
    },
}
