"""Premium Card + Travel — L4 under Consumer Finance (소비자 금융).
...
THEME = {
    "domain": "Premium Card + Travel (Consumer Finance)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["premium_card"],
    "horizon": "9-18 months",
    "binding_layer_taxonomy": [
        "Premium Card + Travel — 주요 (Visa V · Mastercard MA)",
        "Premium Card + Travel — 기타·공급망 (American Express AXP · Discover DFS (Capital One 인수 후))",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "Premium Card + Travel (주요)": "Visa V · Mastercard MA",
        "Premium Card + Travel (확장)": "American Express AXP · Discover DFS (Capital One 인수 후)",
    },
}
