"""Ride-share / Last-mile — L4 under Transportation & Logistics (운송 및 물류).
...
THEME = {
    "domain": "Ride-share / Last-mile (Transportation & Logistics)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["ride_share", "ride", "share"],
    "horizon": "6-18 months",
    "binding_layer_taxonomy": [
        "Ride-share / Last-mile — 미국 (Uber UBER · Lyft LYFT · DoorDash DASH · Instacart CART · Grab GRAB)",
        "Ride-share / Last-mile — 비상장 (Lalamove 비상장)",
        "Ride-share / Last-mile — 유럽 (Delivery Hero DHER.DE · Just Eat Takeaway TKWY.AS)",
    ],
    "catalyst_types": [
