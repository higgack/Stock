"""AI Drug Discovery — L4 under Pharmaceuticals & Biotechnology (제약 및 바이오테크).
...
THEME = {
    "domain": "AI Drug Discovery (Pharmaceuticals & Biotechnology)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["drug_discovery", "drug", "discovery"],
    "horizon": "9-24 months",
    "binding_layer_taxonomy": [
        "AI Drug Discovery — 주요 (Recursion)",
        "AI Drug Discovery — 기타·공급망 (Schrödinger · Insilico)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "AI Drug Discovery (주요)": "Recursion",
        "AI Drug Discovery (확장)": "Schrödinger · Insilico",
    },
}
