"""Multi-utility Combined — L4 under Electric & Multi-Utilities (전력 및 복합 유틸리티).
...
THEME = {
    "domain": "Multi-utility Combined (Electric & Multi-Utilities)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["multi", "combined"],
    "horizon": "12-24 months",
    "binding_layer_taxonomy": [
        "Multi-utility Combined — 주요 (DTE · CMS)",
        "Multi-utility Combined — 기타·공급망 (Eversource · CenterPoint)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "Multi-utility Combined (주요)": "DTE · CMS",
        "Multi-utility Combined (확장)": "Eversource · CenterPoint",
    },
}
