"""Diesel Engines + Powertrain — L4 under Machinery, Tools & Components (기계, 도구 및 부품).
...
THEME = {
    "domain": "Diesel Engines + Powertrain (Machinery, Tools & Components)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["diesel_engines", "diesel", "engines"],
    "horizon": "9-24 months",
    "binding_layer_taxonomy": [
        "Diesel Engines + Powertrain — 주요 (Cummins)",
        "Diesel Engines + Powertrain — 기타·공급망 (PACCAR · Volvo Penta)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "Diesel Engines + Powertrain (주요)": "Cummins",
        "Diesel Engines + Powertrain (확장)": "PACCAR · Volvo Penta",
    },
}
