"""Major Pharmaceuticals — L4 under Pharmaceuticals & Biotechnology (제약 및 바이오테크).
...
THEME = {
    "domain": "Major Pharmaceuticals (Pharmaceuticals & Biotechnology)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["pharmaceuticals"],
    "horizon": "9-24 months",
    "binding_layer_taxonomy": [
        "Major Pharmaceuticals — 주요 (Johnson & Johnson JNJ · Eli Lilly LLY · Merck MRK)",
        "Major Pharmaceuticals — 기타·공급망 (Pfizer PFE · AbbVie ABBV · Bristol-Myers BMY)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "Major Pharmaceuticals (주요)": "Johnson & Johnson JNJ · Eli Lilly LLY · Merck MRK",
        "Major Pharmaceuticals (확장)": "Pfizer PFE · AbbVie ABBV · Bristol-Myers BMY",
    },
}
