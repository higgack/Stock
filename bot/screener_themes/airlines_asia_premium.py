"""Asia Premium — L4 under Airlines (항공).
...
THEME = {
    "domain": "Asia Premium (Airlines)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["asia_premium", "asia", "premium"],
    "horizon": "6-18 months",
    "binding_layer_taxonomy": [
        "Asia Premium — 일본 (ANA 9202.T · JAL 9201.T)",
        "Asia Premium — 한국 (대한항공 003490.KS · 아시아나 020560.KS)",
        "Asia Premium — 미국 (Singapore Airlines C6L.SI)",
        "Asia Premium — 홍콩 (Cathay 0293.HK)",
    ],
    "catalyst_types": [
