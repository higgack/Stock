"""US Network Carriers — L4 under Airlines (항공).
...
THEME = {
    "domain": "US Network Carriers (Airlines)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["network_carriers", "network", "carriers"],
    "horizon": "6-18 months",
    "binding_layer_taxonomy": [
        "US Network Carriers — 주요 (Delta DAL)",
        "US Network Carriers — 기타·공급망 (United UAL · American AAL)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "US Network Carriers (주요)": "Delta DAL",
        "US Network Carriers (확장)": "United UAL · American AAL",
    },
}
