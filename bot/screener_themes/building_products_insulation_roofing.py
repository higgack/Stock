"""Insulation + Roofing — L4 under Building Products & Construction (건축 제품 및 건설).
...
THEME = {
    "domain": "Insulation + Roofing (Building Products & Construction)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["insulation_roofing", "insulation", "roofing"],
    "horizon": "9-24 months",
    "binding_layer_taxonomy": [
        "Insulation + Roofing — 주요 (Owens Corning)",
        "Insulation + Roofing — 기타·공급망 (Masco)",
    ],
    "catalyst_types": [
