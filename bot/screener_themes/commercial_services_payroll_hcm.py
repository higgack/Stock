"""Payroll + HCM — L4 under Commercial & Professional Services (상업 및 전문 서비스).
...
THEME = {
    "domain": "Payroll + HCM (Commercial & Professional Services)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["payroll"],
    "horizon": "9-18 months",
    "binding_layer_taxonomy": [
        "Payroll + HCM — 주요 (Automatic Data Processing ADP · Paychex PAYX · Workday WDAY)",
        "Payroll + HCM — 기타·공급망 (Paycom PAYC · Paylocity PCTY · Ceridian CDAY · TriNet TNET)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "Payroll + HCM (주요)": "Automatic Data Processing ADP · Paychex PAYX · Workday WDAY",
        "Payroll + HCM (확장)": "Paycom PAYC · Paylocity PCTY · Ceridian CDAY · TriNet TNET",
    },
}
