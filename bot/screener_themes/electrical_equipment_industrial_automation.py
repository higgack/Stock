"""Industrial Automation — L4 under Electrical Equipment (전력기기).
...
THEME = {
    "domain": "Industrial Automation (Electrical Equipment)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["industrial_automation"],
    "horizon": "9-24 months",
    "binding_layer_taxonomy": [
        "Industrial Automation — 미국 (Rockwell Automation ROK · Emerson EMR · Honeywell HON)",
        "Industrial Automation — 유럽 (Schneider SU.PA · Siemens SIE.DE · ABB ABBN.SW)",
        "Industrial Automation — 일본 (Mitsubishi Electric 6503.T · Yaskawa 6506.T · Fanuc 6954.T · Keyence 6861.T)",
    ],
    "catalyst_types": [
