"""Water Heating — L4 under Building Products & Construction (건축 제품 및 건설).
...
THEME = {
    "domain": "Water Heating (Building Products & Construction)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["water_heating", "heating"],
    "horizon": "9-24 months",
    "binding_layer_taxonomy": [
        "Water Heating — 미국 (A.O. Smith)",
        "Water Heating — 비상장 (Rheem 비상장)",
    ],
    "catalyst_types": [
