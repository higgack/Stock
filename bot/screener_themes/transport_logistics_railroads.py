"""Railroads — L4 under Transportation & Logistics (운송 및 물류).
...
THEME = {
    "domain": "Railroads (Transportation & Logistics)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["railroads"],
    "horizon": "6-18 months",
    "binding_layer_taxonomy": [
        "Railroads — 주요 (Union Pacific · CSX)",
        "Railroads — 기타·공급망 (NSC · CN · CP)",
    ],
    "catalyst_types": [
