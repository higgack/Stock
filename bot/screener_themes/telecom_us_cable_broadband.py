"""US Cable + Broadband — L4 under Telecommunication Services (통신 서비스).
...
THEME = {
    "domain": "US Cable + Broadband (Telecommunication Services)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["cable_broadband"],
    "horizon": "9-24 months",
    "binding_layer_taxonomy": [
        "US Cable + Broadband — 미국 (Comcast CMCSA · Charter Communications CHTR · Dish Network DISH (SATS) · Altice USA ATUS · Cable One CABO)",
        "US Cable + Broadband — 비상장 (Mediacom 비상장 · Cox Communications 비상장)",
    ],
    "catalyst_types": [
