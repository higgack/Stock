"""US Low-cost — L4 under Airlines (항공).
...
THEME = {
    "domain": "US Low-cost (Airlines)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["cost"],
    "horizon": "6-18 months",
    "binding_layer_taxonomy": [
        "US Low-cost — 주요 (Southwest LUV · Alaska ALK · JetBlue JBLU)",
        "US Low-cost — 기타·공급망 (Allegiant ALGT · Spirit SAVE · Frontier ULCC · Sun Country SNCY)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "US Low-cost (주요)": "Southwest LUV · Alaska ALK · JetBlue JBLU",
        "US Low-cost (확장)": "Allegiant ALGT · Spirit SAVE · Frontier ULCC · Sun Country SNCY",
    },
}
