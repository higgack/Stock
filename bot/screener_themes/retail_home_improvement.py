"""Home Improvement — L4 under Retail (소매).
...
THEME = {
    "domain": "Home Improvement (Retail)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["improvement"],
    "horizon": "6-18 months",
    "binding_layer_taxonomy": [
        "Home Improvement — 미국 (Home Depot HD · Lowe's LOW · Floor & Decor FND · Sherwin-Williams SHW (paint) · Tractor Supply TSCO · Builders FirstSource BLDR · Restoration Hardware RH)",
        "Home Improvement — 비상장 (Ace Hardware 비상장 · True Value 비상장)",
    ],
    "catalyst_types": [
