"""Facility Services — L4 under Commercial & Professional Services (상업 및 전문 서비스).
...
THEME = {
    "domain": "Facility Services (Commercial & Professional Services)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["facility"],
    "horizon": "9-18 months",
    "binding_layer_taxonomy": [
        "Facility Services — 주요 (Cintas CTAS · ABM Industries ABM · Rollins ROL)",
        "Facility Services — 기타·공급망 (UniFirst UNF · Service Corp SCI · ADT ADT · Brinks BCO)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "Facility Services (주요)": "Cintas CTAS · ABM Industries ABM · Rollins ROL",
        "Facility Services (확장)": "UniFirst UNF · Service Corp SCI · ADT ADT · Brinks BCO",
    },
}
