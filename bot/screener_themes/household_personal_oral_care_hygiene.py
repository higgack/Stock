"""Oral Care + Hygiene — L4 under Household & Personal Products (가정 및 개인용품).
...
THEME = {
    "domain": "Oral Care + Hygiene (Household & Personal Products)",
    "layer": "L4_SUBINDUSTRY",
    "aliases": ["oral_care", "oral", "hygiene"],
    "horizon": "9-18 months",
    "binding_layer_taxonomy": [
        "Oral Care + Hygiene — 주요 (Colgate)",
        "Oral Care + Hygiene — 기타·공급망 (P&G · Church & Dwight)",
    ],
    "catalyst_types": [
    ...
    "regional_concentration": {
        "Oral Care + Hygiene (주요)": "Colgate",
        "Oral Care + Hygiene (확장)": "P&G · Church & Dwight",
    },
}
