...
_INDUSTRY_KR: dict[str, str] = {
    ...
    # ── NASDAQ 어휘 3차 — 꼬리 전량(프로브 200) ──
    # 2026-08-19 2차 반영 후 한글화 96.9%, 남은 34종을 전부 넣는다.
    # ⚠️ `Professional and commerical equipment` 는 원천의 **오타를
    #    그대로** 키로 쓴다 — 고쳐 쓰면 영원히 매칭되지 않는다.
    "Oil Refining/Marketing": "석유 정제·유통",
    "Misc Health and Biotechnology Services": "기타 헬스케어·바이오 서비스",
    "Ophthalmic Goods": "안경·안과용품",
    "Plastic Products": "플라스틱 제품",
    "Shoe Manufacturing": "신발 제조",
    "Specialty Foods": "특수식품",
    "Fluid Controls": "유체 제어기기",
    "Retail: Computer Software & Peripheral Equipment": "소프트웨어·주변기기 소매",
    "Paper": "제지",
    "Motor Vehicles": "자동차",
    "Newspapers/Magazines": "신문·잡지",
    "Water Sewer Pipeline Comm & Power Line Construction": "상하수도·배관·통신·송전 건설",
    "Forest Products": "임산물",
    "Rental/Leasing Companies": "렌탈·리스",
    "Auto & Home Supply Stores": "자동차·생활용품 소매",
    "Textiles": "섬유",
    "Meat/Poultry/Fish": "육류·가금·수산",
    "Garments and Clothing": "의류 제조",
    "Accident &Health Insurance": "상해·건강보험",
    "Diversified Financial Services": "종합 금융서비스",
    "Consumer Electronics/Video Chains": "가전·전자 소매체인",
    "Medical Electronics": "의료용 전자기기",
    "Retail-Drug Stores and Proprietary Stores": "약국·드럭스토어",
    "Misc Corporate Leasing Services": "기타 기업 리스 서비스",
    "Books": "도서",
    "Wholesale Distributors": "도매 유통",
    "Precision Instruments": "정밀기기",
    "Paints/Coatings": "도료·코팅",
    "General Bldg Contractors - Nonresidential Bldgs": "비주거 건축 시공",
    "Professional and commerical equipment": "전문·상업용 장비",
    "Pharmaceuticals and Biotechnology": "제약·바이오",
    "Electronics Distribution": "전자부품 유통",
    "Tools/Hardware": "공구·철물",
    "Other Transportation": "기타 운송",
    # ── GICS sub-industry 3차 — 꼬리 전량 ──
    # 2차 반영 후 75.7%, 남은 63종. 1종목짜리까지 포함해 100% 를
    # 노린다 — 신고저·급등락은 소형주가 자주 올라오는 화면이라
    # '꼬리'가 곧 사용자가 보는 행이다.
    "Industrial Conglomerates": "산업 복합기업",
    "Internet Services & Infrastructure": "인터넷 서비스·인프라",
    "Health Care Supplies": "의료용 소모품",
    ...
    "Fertilizers & Agricultural Chemicals": "비료·농약",
    "Diversified Support Services": "종합 지원서비스",
    "Construction Materials": "건축소재",
    "Rail Transportation": "철도운송",
    "Passenger Airlines": "여객 항공",
    "Personal Care Products": "퍼스널케어 제품",
    "Cargo Ground Transportation": "육상 화물운송",
    "Electronic Manufacturing Services": "전자 위탁생산(EMS)",
    "Automobile Manufacturers": "완성차",
    "Health Care REITs": "헬스케어 리츠",
    "Casinos & Gaming": "카지노·게이밍",
    "Independent Power Producers & Energy Traders": "민자발전·에너지 트레이딩",
    "Industrial Gases": "산업용 가스",
    "Office REITs": "오피스 리츠",
    "Broadline Retail": "종합 소매",
    "Agricultural Products & Services": "농산물·농업 서비스",
    "Integrated Telecommunication Services": "종합 통신서비스",
    "Human Resource & Employment Services": "인사·채용 서비스",
    "Distillers & Vintners": "증류주·와인",
    "Food Retail": "식품 소매",
    "Cable & Satellite": "케이블·위성방송",
    "Integrated Oil & Gas": "종합 석유·가스",
    "Data Center REITs": "데이터센터 리츠",
    "Wireless Telecommunication Services": "무선통신 서비스",
    "Research & Consulting Services": "리서치·컨설팅",
    "Self-Storage REITs": "셀프스토리지 리츠",
    "Trading Companies & Distributors": "상사·유통",
    "Heavy Electrical Equipment": "중전기기",
    "Health Care Facilities": "의료시설(병원)",
    "Hotel & Resort REITs": "호텔·리조트 리츠",
    "Health Care Technology": "헬스케어 IT",
    "Other Specialty Retail": "기타 전문소매",
    "Water Utilities": "수도 유틸리티",
    "Automotive Parts & Equipment": "자동차 부품·장비",
    "Gas Utilities": "가스 유틸리티",
    "Metal, Glass & Plastic Containers": "금속·유리·플라스틱 용기",
    "Multi-Sector Holdings": "복합 지주",
    "Computer & Electronics Retail": "컴퓨터·전자 소매",
    "Data Processing & Outsourced Services": "데이터처리·아웃소싱",
    "Technology Distributors": "IT 유통",
    "Footwear": "신발",
    "Agricultural & Farm Machinery": "농기계",
    "Specialized Consumer Services": "전문 소비자 서비스",
    "Commodity Chemicals": "범용 화학",
    "Reinsurance": "재보험",
    "Distributors": "유통",
    "Leisure Products": "레저용품",
    "Single-Family Residential REITs": "단독주택 리츠",
    "Other Specialized REITs": "기타 특수 리츠",
    "Brewers": "맥주",
    "Industrial REITs": "산업용 리츠",
    "Interactive Home Entertainment": "게임·홈 엔터테인먼트",
    "Passenger Ground Transportation": "육상 여객운송",
    "Timber REITs": "임야 리츠",
    "Homefurnishing Retail": "가구·홈퍼니싱 소매",
}
