...
# 12270(광주 남구) — 2026-04-28/7-1 광주광역시+전라남도 "전남광주통합특별시"
# 통합 출범으로 舊 광주 시도코드(29xxx)는 전부 폐지, 시도코드 12(신설) 하에
# 기초단체가 전남 5개시 → 광주 5개구(동구12210·서구12240·남구12270·북구12300·
# 광산구12330) → 전남 17개군 순서로 재배정. 사용자가 code.go.kr 원문 확인 후
# 제공한 코드를 VM 라이브 조회로 재검증(응답 법정동 방림동·백운동·봉선동 등
# 남구 관할동과 일치, 5개구 전부 정상 응답) — 최초 보류(2026-08-08) 후 확정.
_REGIONS = {
    ...
    "30200": "대전 유성구", "36110": "세종시", "12270": "광주 남구",
}
