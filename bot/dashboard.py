...
(function(){
  ...
  <div class="si-section">
    ...
    <div style="font-size:12px;color:var(--fg-soft);margin-bottom:8px;line-height:1.5">
      ...
      <b>대만</b>은 FinMind, <b>중국 A주</b>는 AKShare 가 주는 <b>일별 PER</b>(월말 표본), 그 외는 yfinance 손익입니다.
      ...
      밴드는 <b>순이익이 평소(중앙값)의 1/5 미만으로 무너진 시점</b>을 제외합니다 — 그때 배수는 valuation 이 아니라 산술 결과라
      한 점이 '최고'를 망가뜨립니다. <b>배수가 크다는 이유만으로는 빼지 않습니다</b>(정당한 재평가 구간이 잘려 현재 PER 이 밴드 밖으로 나갑니다).
