...
def create_fundamentals_analyst(llm):
    def fundamentals_analyst_node(state):
        ...
        system_message = (
            ...
            " INDUSTRY MATCH IS MANDATORY: peers must be in the SAME"
            " industry as the subject ticker — NOT downstream customers,"
            " NOT upstream suppliers, NOT unrelated substitutes."
            " 한솔케미칼 (014680.KS, 정밀화학 / 반도체소재) 2026-05-17"
            " mistakenly listed 000660.KS SK하이닉스 / 066570.KS LG전자"
            " / 2330.TW TSMC / INTC as Comps — those are 반도체 제조사,"
            " i.e. 한솔케미칼's CUSTOMERS, not peers. Right peers for a"
            " KR specialty-chemical / semi-material name are 동진쎄미켐"
            " (005290.KS), 솔브레인 (036830.KS), 후성 (093370.KS),"
            " 이엔에프테크놀로지 (102710.KS). Same trap for KR semi"
            " EQUIPMENT makers — 피에스케이 (319660.KS) 2026-05-17"
            " listed the same SK하이닉스/삼성전자 mix; right peers are"
            " 원익IPS (240810.KS), 한미반도체 (042700.KS), 주성엔지니어링"
            " (036930.KQ), 테스 (095610.KQ). Use yfinance's 'industry'"
            " field on the subject ticker as the starting point and"
            " pick peers whose yfinance 'industry' matches.\n"
