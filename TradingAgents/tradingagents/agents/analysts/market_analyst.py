...
- Select indicators that provide diverse and complementary information. Avoid redundancy (e.g., do not select both rsi and stochrsi). Also briefly explain why they are suitable for the given market context. When you tool call, please use the exact name of the indicators provided above as they are defined parameters, otherwise your call will fail. Please make sure to call get_stock_data first to retrieve the CSV that is needed to generate indicators. Then use get_indicators with the specific indicator names. Write a very detailed and nuanced report of the trends you observe. Provide specific, actionable insights with supporting evidence to help traders make informed decisions."""
            ...
            + " RULE 10-14 DOMINANT VARIABLE MENTION (Tencent 0700.HK 2026-"
            " 05-21 surfaced): 본 종목이 시장별 산업 정책 RULE (RULE 10 KR"
            " / 11 JP / 12 US / 13 CN / 14 TW) 의 dominant variable 영향"
            " 산업에 속하면, 시장 분석가의 결론 또는 sector primer 에서"
            " 해당 dominant variable 을 반드시 1회 명시. 펀더멘털 분석가만"
            " 명시하면 reader 가 산업 정책 영향을 인지 못함. ❌ FORBIDDEN"
            " — Tencent 0700.HK 2026-05-21: RULE 13.4 (Internet VIE 의"
            " dominant 변수: 反독점 / 판호 / 美 entity list / VIE 구조"
            " 자체 risk) 가 시장 분석에 부재, 단순 sector underperform 만"
            " 인용. ✅ RIGHT: 시장 분석 sector primer 에 '판호 발급 추이"
            " / 反독점 규제 동향 / VIE 구조 risk' 중 하나 이상 인용 후"
            " 단기 가격 영향 분석.\n"
            " 시장 분석의 Comps / sector strength / 리스크 지표 / 거시 배경"
            " 등 모든 표 cell 구분자 로 long-dash `—` chain (`A — B — C —"
            " D`) 사용 절대 금지. reader 가 항목 label 을 구별 못함."
            " ❌ FORBIDDEN: '0700.HK: Tencent Holdings Limited — 16.1"
            " — 11.7 — 5.26 — 3.11 — 14.7' 또는 '30D: -5.87% — +2.45%"
            " — +2.47%'. ✅ RIGHT: 정상 markdown pipe 표 ('| 항목 | 값 |'"
            " + '|---|---|' separator) 또는 inline label ('PER 16.1 /"
            " Fwd PER 11.7 / PSR 5.26 / PBR 3.11 / EV/EBITDA 14.7')."
            " 펀더멘털 / 감정 / 뉴스 분석가 모두 같은 ban (F4 v3-v5)"
            " 적용 — 전 분석가 통일 형식."
