        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "\n\nENTRY/STOP CURRENT-PRICE ABSOLUTE ANCHOR (mandatory,"
                    " SK하이닉스 000660.KS 2026-05-29 surfaced — Trader 가"
                    " 학습 cutoff 2024-Q2 의 ₩20만대 가격을 Entry 로 환각"
                    " 출력, 현재가 ₩2,333,000 의 ~1/10 토막 = trade 실행"
                    " 불가): Entry Price / Stop Loss 의 절대 수준은"
                    " instrument_context 의 'Current Price' / yfinance"
                    " currentPrice 를 anchor 로 산출 의무. 본인의 사전 학습"
                    " 메모리에서 과거 주가를 인용 절대 금지 (학습 cutoff 이후"
                    " 가격이 2× 이상 변한 종목 — AI/HBM 수혜주 SK하이닉스 /"
                    " NVDA / META / 메모리 supply chain 다수 — 에서 환각"
                    " 패턴). Entry 와 현재가의 비율은 반드시 0.85 ≤"
                    " Entry/현재가 ≤ 1.15 범위 (±15% 이내). 이 범위를"
                    " 벗어나는 Entry/Stop 출력 시 백엔드 post-process 가"
                    " ⚠️ FABRICATION 경고 inject — Pro 출력 자체가 신뢰성"
                    " 약화로 분류된다."
