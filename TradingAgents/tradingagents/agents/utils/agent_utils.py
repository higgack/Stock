        ...
        try:
            ...
            if peers:
                ...
                base += (
                    ...
                    f" the row.\n"
                    f"\n"
                    f"COLUMN LABELS (mandatory — 茅台 600519.SS 2026-"
                    f"05-19 surfaced this): when rendering the Comps row"
                    f" inline in prose or as a bullet list, EVERY"
                    f" multiple value MUST carry its label. 'PER 20.1 /"
                    f" Fwd PER 17.7 / PSR 9.62 / PBR 6.11 / EV/EBITDA"
                    f" 14.2' is RIGHT. Dash-separated raw '20.1 — 17.7"
                    f" — 9.62 — 6.11 — 14.2' WITHOUT labels is WRONG —"
                    f" reader cannot tell which column is which. If you"
                    f" use a Markdown table instead of prose, the header"
                    f" row MUST contain | TICKER | Company | PER | Fwd"
                    f" PER | PSR | PBR | EV/EBITDA | exactly."
                    f"\n"
