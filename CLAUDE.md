...
- 감사·프로브가 화면과 다른 경로: #35 #56 #80 #105 #114 #169 #275 #305
- 소스 문자열 단언 금지: #19 #67 #89 #93 #117 #120 #150 #230
- 열거형 가드는 새 항목을 못 잡음: #24 #27 #31 #87 #269 #273 #299 #311
- 뮤테이션 통과 시 의심 순서: #68 #91 #155
- 같은 계산 하는 다른 화면 즉시 grep: #38 #147 #211 #241 #248 #254 #288 #289 #291 #293
...
307. **`0건` 은 갈래가 셋인데 화면도 로그도 한 마디도 안 했다**(2026-09-08
    ...
    ⚠️ 그리고 **빈 응답을 6시간 캐시**하고 있었다 — 원천 장애 한 번이 반나절
    빈 달력이 된다(#161·#303 실패는 짧게만). 값이 있으면 6h, 비면 10분.
