...
204. **"우리가 맞나 네이버가 맞나" — 회계 기준을 찾아보면 답이 있다**
    (2026-08-23 슈프리마 EPS·BPS): 둘 다 **네이버(FnGuide)가 맞다**.
    · EPS — K-IFRS 1033(=IAS 33) 기본주당이익은 **가중평균유통보통주식수**로
      나눈다. 슈프리마는 7,257,273 → 6,974,311 로 283k주가 줄었고(자사주
      소각 추정) 그 이익의 일부는 주식이 더 많던 기간에 벌었다 — 기말
      주식수로 나누면 EPS 가 **+2.4% 과대**된다.
