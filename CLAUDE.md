...
- 값을 비웠으면 사유도 말할 것: #43 #123 #129 #131 #189 #195 #228 #234 #282 #290 #292 #295 #296 #297 #298 #304
- 감사·프로브가 화면과 다른 경로: #35 #56 #80 #105 #114 #169 #275
- 소스 문자열 단언 금지: #19 #67 #89 #93 #117 #120 #150 #230
- 열거형 가드는 새 항목을 못 잡음: #24 #27 #31 #87 #269 #273 #299
...
304. **'실시간이라 기준일이 없다'가 22장을 판정 불가로 만들었다**(2026-09-08
    ...
    **'값 수집'** — 우리가 잰 건 우리가 받아온 시각이지 거래소가 그 가격을 찍은
    ...
    대표하면 한쪽은 거짓말).
    ⚠️ 배지는 **15분 초과에만** 뜬다 — 페이지 주기가 30초라 정상 나이는 1분
    이내이고, 늘 뜨는 배지는 아무것도 안 재는 것과 같다(#25·#260).
