...
_NAME_ALIASES: dict[str, str] = {
    ...
    "SK바이오센서": "SK바이오사이언스",
    "메티바이오메드": "메타바이오메드",
    "네페스": "네패스",              # BeOn 오타(운영자 확인 2026-06-24) → KRX 네패스
}
...
_DIRECT_CODES: dict[str, str] = {
    ...
    "휴켐스": "069260",
    "효성첨단소재": "298050",
    "라온테크": "232680", "라온로보틱스": "232680",  # 사명변경 — 신·구명 모두 코드 매핑
    "와이아이케이": "232140",
    "네온테크": "306620",
    "무림제지": "009200",
    "세하": "027970",
    "백광산업": "001340",
    "현대에너지솔루션": "322000",
    # canon_company 표기통일(2026-06-24)로 surfaced 되는 공식명 — KRX 약어/구명과
    # 달라 master 누락 대비 코드 직접(가격 정합 보장, master 의존 X).
    "HD현대에너지솔루션": "322000",   # ← 현대에너지솔루션 사명변경(canon)
    "현대자동차": "005380",           # ← 현대차(canon)
    "제이오": "418550",
    "나노신소재": "121600",
