...
• <b>📈 산업트렌드</b> — 20산업+하위품목(MTI6): 분류 요약보드(초고성장/턴어라운드/부진·가속/둔화·📥수입급증) + 품목 카드(수출·12M MA·YoY막대·TTM 2차트·8지표·해석·원자료) + 하위품목 TOP(급등률·급증액 MoM·수출≥2억) + 🔍추가신호(Gemini) + 🗄월별 아카이브. HSK-MTI 기준
...
<i>최종 갱신: 2026-06-02 — 차트 콜아웃 겹침 해소(최신/MA/저점·축라벨 자동 분산)</i>
"""
