...
• <b>📈 산업트렌드</b> — 20산업+하위(MTI6): 분류보드(초고성장/턴어라운드/부진·가속/둔화·📥수입급증) + 품목 카드(수출·MA·YoY막대·TTM·8지표·해석·원자료) + 하위품목 TOP(급등률·급증액 MoM·수출≥2억) + 🔍추가신호(Gemini) + 🗄아카이브 + 🔗공유 export(단일파일). HSK-MTI 기준
...
<i>최종 갱신: 2026-06-02 — 산업트렌드 🔗 공유용 단일파일 export 추가</i>
"""
