...
• 📥 CSV — 탭별: 신호알림=현재 필터 결과 풀필드(전필드+media_urls 절대경로) · 히트맵=히트맵 표 · 산업트렌드=품목(MTI) <b>요약</b>(품목당 1행·카드 지표 전부: 수출입·YoY·12M MA·단가$/kg·구성HS·관련기업)+<b>월별 원시</b> 2파일 (엑셀 바로 열림)
• 모달 — 카드 클릭 시 같은 dedup 키 과거 발표 인라인 비교 (전번 확정 ↔ 이번 잠정)
  ...
  · 관련종목·회사헤더 시세 등락률(KIS; 5분 갱신·~30분 지연·미제공 공란)
