...
• <b>📈 산업트렌드</b> — 산업분류 20개(반도체·자동차…) 월 수출 추이+12M 이동평균, YoY·ΔYoY 자동분류(초고성장/턴어라운드/부진). HSK-MTI 연계표 기준
...
<i>최종 갱신: 2026-06-02 — 📈산업트렌드 탭(추이·해석문·신호·월별/12M TTM·매일 갱신/익월15일 확정) · 자동분류</i>
"""
