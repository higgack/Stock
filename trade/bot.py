...
<b>📊 대쉬보드</b> <a href="http://136.115.27.77:8765/dashboard/">http://136.115.27.77:8765/dashboard/</a>
모바일·데이터 5분 갱신+새 업데이트 하단알림(1분 체크·30분 자동반영)·BasicAuth·다크모드(19~07 KST). 📡플로우노트 + 잠정/확정 D-N·미파싱백로그·비용 + 📦관세청(📌핀·📈급등률·💵급증액 TOP30·🗄아카이브).

<b>발표 사이클(KST)</b> 11일경 1-10일 잠정 · 21일경 1-20일 잠정(누적·주요만) · 익월1일경 전월 잠정(주요 요약) · 잠정 세부는 익월 상순 API 적재(수일 지연) · 익월15일경 확정=세부 정제(관세청 공식)

<b>⚙️ 자동화 플로우</b> (방문 없이 서버가 자동 갱신 · 비용 ₩0)
• 관세청 <b>customs-probe</b> 10분 → 산업트렌드·히트맵·월별표·관련기업
• DART 매출구성 <b>dart-revenue 매월18일</b> 전수(변경분만) + <b>dart-reparse 매일04:30</b> 파서개선 소급 재파싱(비제품 회계라인 오매핑 차단)
• 관련기업: BeOn 채널 매트릭스 실시간 → 보고서·검색·레퍼런스북 공통소스

<b>📂 뷰</b>
• <b>품목별 / 회사별 / 매트릭스</b>(품목×국가 heatmap)
• <b>📈산업트렌드</b> — 20산업+MTI6: 분류보드(초고성장/턴어라운드/부진·수입모멘텀)·품목카드(수출·MA·YoY·TTM·8지표·해석·원자료)·하위TOP·🔍추가신호·🟢잠정속보·🗄아카이브 (HSK-MTI)
• <b>🏢기업/🗂️전체 보고서</b> — 회사·품목·HS코드 검색 → 월별 수출입(YoY·MoM)+DART 제품구성 AI 종합
• <b>📖레퍼런스북</b> — 품목(MTI)↔구성HS10↔산업↔관련상장사(CSV)
• <b>🏷️큐레이션 후보</b> — 갱신일 18:00 미매핑 고수출 품목 DM(0이면 무음)

<b>🔎 검색·부가</b> 품목/회사/국가 부분일치(회사 정확일치→회사뷰) · 칩 수출입·잠정/확정·🆕신규 · 📥CSV 탭별 풀데이터 · 모달 과거비교·🔗딥링크·관련종목 시세(네이버 실시간)
<b>🏷️ 배지</b> 🟢수출 🟠수입 · 잠정/확정/합산 · 🟡확정 D-N · 🔴지연 D+N · 🆕7일내 신규

<b>💬 명령어</b> (워치·ignore는 봇 <b>DM</b>에서만)
/help·/start — 이 안내
/watch &lt;검색어&gt; — 품목+관련종목 부분일치 DM · /unwatch item|company &lt;검색어&gt; · /unwatch all
/ignore·/unignore·/ignored &lt;msg_id&gt; — 일일 미등록 검사 제외
/hs &lt;검색어&gt; — HS검색→클릭 핀 · /hs &lt;품목&gt; &lt;코드&gt; 직접 · /unhs · /hslist
/map &lt;표기&gt; &lt;코드&gt; — 시세코드 등록 · /unmap
/customs — 관세청 수출입 · /cost — 비용 · /export — 산업트렌드 스냅샷+🔗링크
※ <b>[비온 인사이트]</b>·<b>DART 공시 릴레이</b>는 자동 skip

<i>최종 갱신 2026-06-20 — help 간결화(운영 내부 systemd·API 항목 제거)</i>
"""
