...
• <b>📈 산업트렌드</b> — 20산업+하위(MTI6): 분류보드(초고성장/턴어라운드/부진·가속/둔화·📥수입모멘텀) + 품목 카드(수출·MA·YoY막대·TTM·8지표·해석·원자료) + 하위품목 TOP(급등률·급증액 MoM·수출≥2억) + 🔍추가신호 + 🚀🔄산업내부동학 + 🗄아카이브 + 🔗export. HSK-MTI 기준
...
/export — 산업트렌드 공유: 그 시점 월 스냅샷 파일 + 🔗공개 링크(인증 없음). 대쉬보드 🔗버튼과 동일
...
<i>최종 갱신: 2026-06-02 — 외부 공유 링크 = 월 스냅샷(동결), 라이브는 본인만</i>
"""
