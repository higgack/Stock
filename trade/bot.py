...
• <b>📈 산업트렌드</b> — 산업분류 20개(반도체·자동차…): 수출액+12M MA 추이 · YoY 성장률 막대 · 8지표(YoY·ΔYoY·3M평균·MA대비) · 해석문/신호 · 월별↔12M TTM 토글 · 월별 원자료표. 자동분류(초고성장/턴어라운드/부진), HSK-MTI 연계표 기준
...
<i>최종 갱신: 2026-06-02 — 📈산업트렌드 차트 보강(축라벨·최신/저점/MA callout·범례·YoY막대축·TTM숨김 버그수정)</i>
"""
