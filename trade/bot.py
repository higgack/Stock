...
• <b>📈 산업트렌드</b> — 산업분류 20개(반도체·자동차…): 분류 요약보드(초고성장/턴어라운드/부진·가속/둔화·📥수입급증 선행신호) + 품목별 카드(수출액+12M MA·YoY막대·TTM 2차트·8지표·해석문·원자료표). 자동분류, HSK-MTI 연계표 기준
...
<i>최종 갱신: 2026-06-02 — 📈산업트렌드 C(수입 급증 선행신호 보드) · A(분류 요약보드) · TTM 2차트</i>
"""
